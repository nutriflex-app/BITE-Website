...
export const homeFaqs: Faq[] = [
  {
    q: 'What is Mr BITE?',
    a: 'Mr BITE is a nutrition tracking and AI coaching app for iPhone and Android, free to download. It lets you log any meal in seconds, gives you personalised calorie and protein targets, and plans your week from recipes that fit those targets.',
  },
  {
  ...
  {
    q: 'Is Mr BITE free?',
    a: 'Yes, and it stays useful for free. Logging your food, planning your week and your own data are free with no ads. The AI features (photo and voice logging, Mr BITE chat, plan generation, recipe imports) come with a monthly allowance that refreshes on the 1st. BITE Coach removes the allowances if you want more.',
  },
  {
